...
//        System.out.println(mandalorianVer2);
        ...
        ThreadMandalorian threadMandalorian = new ThreadMandalorian();
        ThreadMandalorian threadMandalorian2 = new ThreadMandalorian();
        threadMandalorian.start();
        threadMandalorian2.start();
    }
}
